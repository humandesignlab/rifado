...
const options = [
  { key: 1, text: "Draw Date (ascending order)", value: 1 },
  { key: 2, text: "Draw Date (descending order)", value: 2 },
  { key: 3, text: "Prize amount (descending order)", value: 3 },
  { key: 4, text: "Prize amount (ascending order)", value: 4 },
  { key: 5, text: "Sold tickets (descending order)", value: 5 },
  { key: 6, text: "Sold tickets (ascending order)", value: 6 }
];
class RaffleIndex extends Component {
  ...
  handleClose = () => {
    ...
    console.log("this.child ", this.child.onSubmit());
    this.child.onSubmit();
  };
